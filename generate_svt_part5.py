# -*- coding: utf-8 -*-
"""Generates courses_3eme_svt_part5.ts (Lessons 23 to 26: Nutrition et Digestion chez l'Homme)"""
...
with open('src/data/courses_3eme_svt_part5.ts', 'w', encoding='utf-8') as f:
    f.write(code)

print("Created src/data/courses_3eme_svt_part5.ts successfully.")
