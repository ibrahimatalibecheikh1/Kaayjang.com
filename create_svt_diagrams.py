# -*- coding: utf-8 -*-
"""Generates SVG scientific diagrams for SVT 3ème."""
...
with open('src/data/diagrams_3eme_svt.ts', 'w', encoding='utf-8') as f:
    f.write(content)

print("Created src/data/diagrams_3eme_svt.ts successfully.")
