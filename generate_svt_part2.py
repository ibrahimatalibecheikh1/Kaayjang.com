# -*- coding: utf-8 -*-
"""Generates courses_3eme_svt_part2.ts (Lessons 8 to 14: Microbes & Immunologie)"""
...
with open('src/data/courses_3eme_svt_part2.ts', 'w', encoding='utf-8') as f:
    f.write(code)

print("Created src/data/courses_3eme_svt_part2.ts successfully.")
